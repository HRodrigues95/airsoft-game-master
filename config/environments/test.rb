...
Rails.application.configure do
  ...
  config.cache_classes = true # Turn false under Spring and add config.action_view.cache_template_loading = true.
  ...
  config.action_mailer.delivery_method = :test # ActionMailer::Base.deliveries array.
